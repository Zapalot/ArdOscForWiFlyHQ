...
SoftwareSerial softSerial(wiflyRxPin,wiflyTxPin); 
unsigned long receiveTimeout= 15; // adjust to match your Baudrate: Should be around 2-3 with 115200 Baud, higher at lower Baudrates
WiFly wifly;
